...
│   └── 12_Planning/                 # Research plans, ideas, roadmaps
│       └── 1_Wiki/                  # Distilled planning conclusions & key rules
│
├── 2_Log/                           # Session logs (S###_log.md)
│   ├── 1_Wiki/                      # Distilled findings & session registry
...
4. **Idea Separation:** Hypotheses and ideas generated by AI are stored separately in `1_Concept/12_Planning/`, not in logs.
...
2. **Summarize to Wiki**: Add a 1-2 line summary to `2_Log/1_Wiki/` knowledge documents with a link to the archived log.
3. **Update Session Registry**: Add a row to `2_Log/1_Wiki/Session_Registry.tsv`:
   ```
