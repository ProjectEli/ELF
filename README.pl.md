...
Aby utworzyć nowy projekt ze strukturą ELF v2, uruchom `0_Meta/ELF_generator.bat`.
...
Wpisz nazwę projektu, a struktura folderów 0–6, dokumenty meta, `.gitignore` i inicjalizacja Git zostaną wykonane automatycznie.
