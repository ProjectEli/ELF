...
- [ ] trial stub 생성: `elf trial new [제목]` 권장(현행 trialTemplate append; CLI 미설치 시 `templates/trialTemplate.md` 수동 복사) → (선택) `### 배경 (Background)`(맥락>목표 시: 의도+발의주체) + `### 목표 (Goal)` + `### 조건 (Conditions)`(parameter·제약 확정)
