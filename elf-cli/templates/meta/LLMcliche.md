...
| 상투 명사 | tapestry · landscape · realm · paradigm · testament · cornerstone · beacon · myriad · plethora · synergy · ecosystem · verdict(평가·검사 결과를 사법 register로 격상 — result/pass-fail로) · readout(계측 결과의 막연 명사화 — measurement/signal로; 하드웨어 판독 맥락은 §4) · X family(방법론의 비학술 은유 분류 — methods 등 구체 분류어로; 정의된 분류 용법은 §4) · provenance(출처의 과장 명사화 — source·출처·data lineage 등 구체어로, 예외 없음) · dossier(정리·취합의 비학술 격상 — record/summary로) · caveat(한계·단서의 상투 헤지 명사 — limitation·유의점으로) |
